...
describe('Question', () => {
    ...
    it('Displays first question correctly on mount', async () => {
        ;(getAllQuestions as jest.Mock).mockResolvedValueOnce(resp)
    ...
    it('Shows a message when no questions are found', async () => {
        ;(getAllQuestions as jest.Mock).mockResolvedValueOnce({ data: [] })
        const wrapper = factory()
        await flushPromises()
    ...
    it('Shows an error message if the API call fails', async () => {
        ;(getAllQuestions as jest.Mock).mockRejectedValueOnce(
    ...
    it('Shows an error server rejects the answers', async () => {
        ;(getAllQuestions as jest.Mock).mockResolvedValueOnce(resp)
        ;(createAnswerSet as jest.Mock).mockRejectedValueOnce(
